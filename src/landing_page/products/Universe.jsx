import PartnerPlatformComponent from "./PartnerPlatformComponent";
 ...
 function Universe() {
    ...
    const text1= 'Our asset management venture that is creating simple and transparent index funds to help you save for your goals.';

    const src2= 'sensibullLogo.svg '
    const text2= 'Options trading platform that lets you create strategies, analyze positions, and examine data points like open interest, FII/DII, and more. ';

    const src3= 'tijoriLogo.svg '
    const text3= 'Investment research platform that offers detailed insights on stocks, sectors, supply chains, and more.';

    const src4= 'streakLogo.png '
    const text4= 'Systematic trading platform that allows you to create and backtest strategies without coding.';

    const src5= 'smallcaseLogo.png '
    const text5= 'Thematic investing platform that helps you invest in diversified baskets of stocks on ETFs.';

    const src6= 'dittoLogo.png '
    const text6= 'Personalized advice on life and health insurance. No spam and no mis-selling.';
    return ( 
